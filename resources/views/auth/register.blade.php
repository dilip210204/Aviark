                            ...
                            <form method="POST" action="{{ route('register') }}" class="mt-4">
                              @csrf
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="{{ old('name') }}" class="form-control mb-0 @error('name') is-invalid @enderror" id="fullname" placeholder="Your Full Name" required>
                                     @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" value="{{ old('email') }}" class="form-control mb-0 @error('email') is-invalid @enderror" id="email" placeholder="Enter email" required >
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
